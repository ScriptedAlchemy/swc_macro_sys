...
describe('E2E: Module Federation Apps', () => {
  ...
  describe('Host Application', () => {
    ...
    it('should execute processItems function', async () => {
      ...
      const hasProcessItems = consoleLogs.some(log => 
        log.includes('processItems') || log.includes('Processed')
      );
  ...
  describe('Remote Application', () => {
    ...
    it('should handle button clicks', async () => {
      ...
      const hasClickLog = consoleLogs.some(log => 
        log.includes('clicked') || log.includes('Remote button')
      );
  ...
  describe('Optimization Impact', () => {
    it('should not break app functionality after optimization', async () => {
      ...
      const optimizedChunk = fs.readdirSync(hostDistPath)
