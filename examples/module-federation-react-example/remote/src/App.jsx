    ...
    <div>
      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        <div className="component-demo">
          <Title level={3} className="component-title">UserCard Component</Title>
          <UserCard 
            user={{
              name: 'Jane Doe',
        ...
        <div className="component-demo">
          <Title level={3} className="component-title">DataTable Component</Title>
          <DataTable />
        </div>

        <div className="component-demo">
          <Title level={3} className="component-title">ChartWidget Component</Title>
          <ChartWidget type="bar" />
        </div>

        <div className="component-demo">
          <Title level={3} className="component-title">FormBuilder Component</Title>
          <FormBuilder 
            fields={[
