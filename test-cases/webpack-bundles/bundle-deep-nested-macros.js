...
// main.js - Entry point with NO macros (always loads A, B, C)

console.log('=== Deep Nested Macros Demo ===');
console.log('Entry point: Loading all three feature modules (no macro at top level)');

// Always load A, B, C - macros are deep inside the module graph
...
console.log('Main application completed - all features processed');
